...
c.EntrypointService.systems = [
    {'name': 'cori', 'displayname': 'Cori', 'hostname': 'cori'},
    {'name': 'perlmutter', 'displayname': 'Perlmutter', 'hostname': 'perlmutter'}
]

c.EntrypointService.entrypoint_types = [
    {'name': 'conda', 'displayname': 'Conda', 'mutable': True},
    {'name': 'script', 'displayname': 'Startup Script', 'mutable': True},
    {'name': 'shifter', 'displayname': 'Shifter Image', 'mutable': False}
]
